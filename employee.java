...
mysql> INSERT INTO dept VALUES ('40','OPERATIONS','BOSTON');slect * from emp
Query OK, 1 row affected (0.01 sec)

    -> INSERT INTO dept VALUES ('40','OPERATIONS','BOSTON');slect * f;rom emp
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'slect * from emp
INSERT INTO dept VALUES ('40','OPERATIONS','BOSTON')' at line 1
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'slect * f' at line 1
    -> select * from emp;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'rom emp
